...
const images = ref([
	'',
	'https://source.unsplash.com/random/800x800?sig=21',
	'https://source.unsplash.com/random/800x800?sig=22',
	'https://source.unsplash.com/random/800x800?sig=23',
	'https://source.unsplash.com/random/800x800?sig=24',
	'https://source.unsplash.com/random/800x800?sig=25',
])
			...
			<div class="md:flex gap-4 justify-between mx-auto w-full">
				...
				<div class="md:w-[60%] bg-white p-3 rounded-lg">
					...
					<div class="flex items-center pt-1.5">
						...
						<p class="text-[#FF5353]">Дополнительная скидка 5%</p>
					</div>
					...
					<div class="flex items-center justify-start my-2">
						...
						<span class="text-[13px] font-light ml-2"
							>5 213 Отзывов 1,000+ заказов</span
						>
					</div>
					...
					>
						<div v-if="isInCart">В корзине</div>
