			...
			<div v-else class="md:flex gap-4 justify-between mx-auto w-full">
				<div class="md:w-[65%]">
					<div class="bg-white rounded-lg p-4">
						<div class="text-2xl font-bold mb-2">
							Корзина ({{ userStore.cart.length }})
						</div>
					</div>

					<div class="bg-[#FEEEEF] rounded-lg p-4 mt-4">
						<div class="text-red-500 font-bold">
							Приветственная сделка распространяется только на 1 товар
						</div>
					</div>
				...
				<div class="md:w-[35%]">
					...
					<div id="PaymentProtection" class="bg-white rounded-lg p-4 mt-4">
						<div class="text-lg font-semibold mb-2">Методы оплаты</div>
						...
						<p class="my-2">
							Получите полный возврат денег, если товар не соответствует
							описанию или если это не так доставлен
						</p>
					</div>
				</div>
			</div>
